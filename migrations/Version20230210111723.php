 ...
 */
final class Version20230210111723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, midi TIME NOT NULL, soir TIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
